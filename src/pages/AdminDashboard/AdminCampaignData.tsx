            ...
            <div className="hidden sm:flex items-center gap-3 sm:gap-4">
              ...
              <DropdownMenu>
                ...
                >
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem className="cursor-pointer py-1 flex items-center justify-between px-5 hover:bg-[linear-gradient(291deg,_#38B6FF_-45.64%,_#09489D_69.04%)] w-full text-red-600">
