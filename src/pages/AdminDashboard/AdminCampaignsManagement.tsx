...
export default function AdminCampaignManagement() {
  ...
  const [searchTermCustom, setSearchTermCustom] = useState("");
  ...
  // console.log({customCampaignData})
              ...
              <tbody>
                {currentData.map((campaign: any) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      {campaign.payment?.status === "success"
                        ? "System Auto"
                        : "N/A"}
                    </td>
        ...
        <div className="hidden md:block">
          <div className="rounded-lg border border-[#11214D] bg-bg-dashboard">
            <table className="min-w-full divide-y divide-slate-800/40">
              <thead>
                <tr className="text-left text-[#38B6FF]">
                  <th className="py-3 px-4">Tatal Screen</th>
                  <th className="py-3 px-4">Customer</th>
                  <th className="py-3 px-4">Status</th>
                  <th className="py-3 px-4">Approved By</th>
                  <th className="py-3 px-4">Budget</th>
              ...
              <tbody>
                {customCampaignData.map((campaign: any) => (
                  <tr
                    ...
                    className="border-b border-slate-800/40 last:border-0 text-[#AEB9E1]"
                  >
                    <td className="py-3 px-4">{campaign.screens.length}</td>
                    <td className="py-3 px-4">
                      {campaign.customer?.first_name}{" "}
                      {campaign.customer?.last_name}
                    </td>
                    ...
                    <td className="py-3 px-4">
                      ${campaign.CustomPayment[0]?.amount}
                    </td>
                    <td className="py-3 px-4">
                      {new Date(campaign.startDate).toLocaleDateString()}
                    </td>
