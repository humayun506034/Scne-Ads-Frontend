...
//   const { data, isLoading, error } = useGetAllScreenQuery({searchTerm, currentPage}) as {
...
//     console.log("[v0] View screen:", screen.id);
...
//   const totalPages =data?.data?.meta?.totalPages as number;
                ...
                <tbody>
                  {screens.map((screen, index) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-6">
                        <div className="text-gray-200">
                          <div className="font-medium">{screen.screen_size}</div>
                          <div className="text-sm text-gray-400">{screen.resolution}</div>
                        </div>
                      </td>
                      <td className="py-4 px-6">
                        <div className="flex items-center text-gray-300">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm mb-3">
                        <div>
                          <span className="text-gray-400">Size: </span>
                          <span className="text-gray-200">{screen.screen_size}</span>
                        </div>
                        <div>
                          <span className="text-gray-400">Price: </span>
                          <span className="text-green-400 font-semibold">
                        ...
                        <div className="col-span-2">
                          <span className="text-gray-400">Location: </span>
                          <span className="text-gray-200">{screen.location}</span>
                        </div>
                      </div>
