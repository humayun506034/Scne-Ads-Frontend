...
const Signup = () => {
  ...
  return (
    <div className="w-full min-h-screen relative">
      ...
      <div className="w-full my-20 flex justify-center items-center pt-28">
      ...
      {imagePreview ? (
        <div className="relative">
          <img
            src={imagePreview}
            alt="Profile preview"
            className="w-32 h-32 rounded-lg object-cover border-2 border-[#47B5FF]" // changed rounded-full -> rounded-lg
          />
          <button
            type="button"
            onClick={removeImage}
        ...
        <div className="w-32 h-32 rounded-lg border-2 border-dashed border-white/40 flex items-center justify-center bg-white/5"> {/* changed rounded-full -> rounded-lg */}
          <Upload className="w-8 h-8 text-white/60" />
        </div>
      )}
    </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                >
                  ...
                  <p className="text-sm">
                    Choose this option if you are an agency or consultant
                    looking to manage advertising campaigns on behalf of
                    multiple clients
                  </p>
                </motion.div>
              </div>
                ...
                <p className="text-white/80 text-sm md:text-base mt-4">
                  ...
                  <Link to="/login">
                    <Button
                      type="button"
                      variant="link"
                      className="text-[#14CA74] cursor-pointer hover:text-[#38A3E8] p-0 h-auto font-medium text-sm md:text-base underline-offset-2"
                    >
                      Log in
                    </Button>
                  </Link>
