...
const UserPanel: React.FC = () => {
  const [selectedAccount, setSelectedAccount] = useState<"personal" | "business" | null>(null);
...
<h1 className="text-[#E4E7EC] text-4xl pb-20">Choose what type of account do you want:</h1>
        {/* Cards */}
        <div className="flex gap-12">
            {/* Personal Account */}
         <div className={`border w-96 border-[#38B6FF] rounded-2xl px-11 py-8 flex flex-col items-center hover:shadow-lg transition-shadow duration-300`}>
        <div className="flex items-center flex-col gap-4">
          <User className="w-8 h-8 text-[#FFFFFF]" />
          <h3 className="text-xl font-semibold text-[#FFFFFF]">Personal Account</h3>
          <p className="text-sm text-center text-[#FFFFFF]">
            Same benefits as a business account, but less hassle! Invoices will be issued to you directly.
          </p>
        </div>
        <div className="mt-4">
         <Link to="/user-dashboard/userBillingPersonalAcc"> <CommonDashboardButton
            title="Select"
      ...
      <div className={`border w-96 border-[#38B6FF] rounded-2xl px-11 py-8 flex flex-col items-center hover:shadow-lg transition-shadow duration-300 ${
          selectedAccount === "business"
                    ? "border-[#38B6FF]"
                    : "border-[#38B6FF] bg-[#0B1739]"
         }`}>
        <div className="flex flex-col items-center gap-4">
          <Briefcase className="w-8 h-8 text-[#FFFFFF]" />
          <h3 className="text-lg font-semibold text-[#FFFFFF]">Business Account</h3>
