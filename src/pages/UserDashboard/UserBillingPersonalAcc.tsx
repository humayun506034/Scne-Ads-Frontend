...
<h1 className="text-[#E4E7EC] text-4xl pb-20">Please enter your Personal Account details</h1>
        {/* Form */}
        <form
 ...
 <CommonInputField
   ...
   <div className="md:col-span-2"><CommonInputField
            label="Address"
            type="address"
          ...
          <div className="col-span-1 md:col-span-2 flex justify-center">
            <button
            >
              <CommonDashboardButton title="Save Details"
              className="px-14 py-2 mt-8 rounded-full text-xl text-white font-semibold transition"/>
            </button>
          </div>
        </form>
        <p className="text-[#B1C0D5] pt-9 hover:text-white underline cursor-pointer">Switch to a business account</p>
      </div>
        </main>
      </div>
    </div>
