...
const CostEstimator: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#081028] px-4 sm:px-6 md:px-8 py-8 md:py-12 text-white relative">
      ...
      {/* Info Note */}
      <div className="flex md:max-w-5xl md:flex-row items-start md:justify-between mt-6 bg-[#0B1739] text-gray-300 px-4 sm:px-5 py-3 rounded-md">
        <p className="text-sm">
      ...
      {/* Step One */}
      <div className="flex flex-col md:flex-row justify-between mt-5 gap-8 md:gap-6">
