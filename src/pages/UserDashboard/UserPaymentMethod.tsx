...
const PaymentMethodModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="relative bg-[#081028] rounded-3xl p-8 max-w-3xl shadow-2xl">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className="w-full bg-[#0B1739] border border-[#2D3748] rounded-lg px-4 py-3 text-[#E4E7EC] placeholder-[#37446B] focus:outline-none focus:border-[#3182CE] transition-colors"
            maxLength={19}
          />
        </div>
        ...
        <div className=" grid grid-cols-3 gap-4 mb-8">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleInputChange("postalCode", e.target.value.slice(0, 10))
              }
              placeholder="12345"
              className="w-full bg-[#0B1739] border border-[#2D3748] rounded-lg px-4 py-3 text-[#E4E7EC] placeholder-[#37446B] focus:outline-none focus:border-[#3182CE] transition-colors"
              maxLength={10}
        ...
        <div className="mt-2 flex justify-center">
          <CommonDashboardButton title="Save Payment" className="px-10 py-2 mt-4  border border-[#38B6FF] text-xl font-semibold cursor-pointer" />
        </div>
      </div>
    </div>
  );
          ...
          <div className="mt-4">
            <div onClick={handleAddPaymentMethod}>
              <CommonDashboardButton
                ...
                className="px-10 py-2 mt-4 border border-[#38B6FF] text-xl font-semibold cursor-pointer"
              />
            </div>
          </div>
        </div>
