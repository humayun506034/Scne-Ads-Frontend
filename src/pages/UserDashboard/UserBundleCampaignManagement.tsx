...
//   // For start/end date inputs
//   const [startDate, setStartDate] = useState<string | null>(null);
//   const [endDate, setEndDate] = useState<string | null>(null);

//   // For predefined filter buttons
...
//   if (endDate) {
//     queryParams.endDate = `${endDate}T00:00:00.000Z`; // better coverage for end date
//   }
...
//   // When a date filter button is clicked, reset start/end dates
...
//   // When a date input changes, reset dateFilter button
...
//             className="bg-[#11214D] text-white px-3 py-2 rounded"
//           />
//           <input
//             type="date"
//             value={endDate || ""}
...
//           {["today", "1d", "7d", "15d", "30d"].map((filter) => (
//             <button
//               key={filter}
